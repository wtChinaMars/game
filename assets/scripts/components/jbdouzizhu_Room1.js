cc.Class({
    ...
    initView:function(){
        ...
        if(btnWechat){
             cc.vv.utils.addClickEvent(btnWechat,this.node,"jbdouzizhu_Room1","onBtnWeichatClicked");
        }
    ...
    initSingleSeat:function(seat){
        ...
        this._seats[index].setInfo(seat.name,this.getConvert(seat.coins));
        this._seats[index].setReady(seat.ready);
        this._seats[index].setOffline(isOffline);
        this._seats[index].setID(seat.userid);
        this._seats[index].voiceMsg(false);
        
        this._seats2[index].setInfo(seat.name,this.getConvert(seat.coins));
    ...
    cc.vv.anysdkMgr.share("豆乐棋牌-二人斗地主！" ,"房号:" + cc.vv.gameNetMgr.roomId + " 玩法:" + cc.vv.gameNetMgr.getWanfa());
    },
